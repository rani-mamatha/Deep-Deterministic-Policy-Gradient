...
class Config:
    ...
    # Environment scales - REDUCED FOR FASTER CPU TESTING
    SMALL_SCALE = {
        'edge_nodes': 10,
        'cloud_nodes': 10,
        'num_jobs': 1000,        # Reduced from 10000 for faster testing
        'name': 'small'
    }
    ...
    MEDIUM_SCALE = {
        'edge_nodes': 30,
        'cloud_nodes': 30,
        'num_jobs': 5000,        # Reduced from 100000 for faster testing
        'name': 'medium'
    }
    ...
    LARGE_SCALE = {
        'edge_nodes': 50,
        'cloud_nodes': 50,
        'num_jobs': 10000,       # Reduced from 1000000 for faster testing
        'name': 'large'
    }
