"""
DDPG-CNN: DDPG with CNN (Conv1D)
Baseline method with Conv1D but without GRU or Attention
"""
...
class DDPG_CNN:
    """
    DDPG with CNN (Conv1D) - baseline
    Has Conv1D but no GRU or Attention
    """
